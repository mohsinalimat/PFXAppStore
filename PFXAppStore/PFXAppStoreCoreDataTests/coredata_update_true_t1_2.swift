//
//  coredata_update_true_t1_2.swift
...
class coredata_update_true_t1_2: XCTestCase {
    ...
    func testExample() {
        ...
        if let error = CoreDataHelper.shared.updateHistory(model: HistoryModel(text: "은행", date: Date())) {
