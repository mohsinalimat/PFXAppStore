//
//  history_entities_true_t3_2.swift
...
class history_entities_true_t3_2: XCTestCase {
    ...
    func testExample() {
        ...
        self.provider.recent(isAscending: false, limit: ConstNumbers.maxRecentHistoryCount)
            .subscribe(onSuccess: { models in
                XCTAssertTrue(models.first!.text == "3lMvTNjyoZSj2dxbo77yhGIkEjoua5fy")
                expt.fulfill()
            }, onError: { error in
