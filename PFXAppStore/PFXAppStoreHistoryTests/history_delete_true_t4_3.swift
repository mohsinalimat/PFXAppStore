//
//  history_delete_true_t4_3.swift
...
class history_delete_true_t4_3: XCTestCase {
    ...
    func testExample() {
        ...
        self.provider.update(model: HistoryModel(text: "3lMvTNjyoZSj2dxbo77yhGIkEjoua5fy", date: Date()))
            .subscribe(onCompleted: {
                self.provider.delete(model: HistoryModel(text: "3lMvTNjyoZSj2dxbo77yhGIkEjoua5fy", date: Date()))
                    .subscribe(onCompleted: {
                        XCTAssertTrue(true)
                        expt.fulfill()
                    }) { error in
