//
//  history_delete_false_t5_2.swift
...
class history_delete_false_t5_2: XCTestCase {
    ...
    func testExample() {
        ...
        self.provider.delete(model: HistoryModel(text: "3lMvTNjyoZSj2dxbo77yhGIkEjoua5fy1", date: Date()))
