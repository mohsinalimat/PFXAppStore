...
class search_bloc_true_t1_1: XCTestCase {
    // engligh request
    ...
    func testExample() {
        ...
        bloc.stateRelay
            .subscribe(onNext: { state in
                ...
                if state is FetchedSearchState {
                    fetchedSearchStateCount = fetchedSearchStateCount + 1
                    return
                }
        ...
        XCTAssertEqual(fetchedSearchStateCount, 1)
